...
python setup.py sdist'''
        ...
        slackSend channel: '#devops-notifs', color: 'good', message: "${env.JOB_NAME} - #${env.BUILD_NUMBER} Success (<${env.BUILD_URL}|Open>)", teamDomain: 'nuxeo', token: 'u6jxyUxDz7imQindMfJcsZXf'
    } catch (e) {
